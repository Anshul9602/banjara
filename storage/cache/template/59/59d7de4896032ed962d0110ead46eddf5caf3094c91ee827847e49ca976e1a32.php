...
class __TwigTemplate_9f371bf506e4ebd727e9865d394401f8f0414830e3f5d29d90a80b63ca105eb1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
                // line 391
                echo "\t\t\t\t\t\t
\t\t\t\t\t\t\t<div class=\"col-md-4 p-2 col-6\">
\t\t\t\t\t\t\t\t<div class=\"instagram-post\" style=\"    display: flex;    justify-content: center;\">
\t\t\t\t\t\t\t\t\t<a href=\"https://www.instagram.com/banjarahome_/\" target=\"_blank\">
\t\t\t\t\t\t\t\t\t\t<div class=\"cmm\"
\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 100px; height: 400px; position: relative; overflow: hidden;\">
\t\t\t\t\t\t\t\t\t\t\t";
                // line 397
                if ((twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", true, true, false, 397) && twig_in_filter(".mp4", twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 397)))) {
                    // line 398
                    echo "\t\t\t\t\t\t\t\t\t\t\t<!-- Video section -->
...
\t\t\t\t\t\t\t\t\t\t\t\t<source src=\"";
                    // line 401
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 401);
                    echo "\" type=\"video/mp4\">
\t\t\t\t\t\t\t\t\t\t\t</video>
\t\t\t\t\t\t\t\t\t\t\t";
                } else {
...
\t\t\t\t\t\t\t\t\t\t\t<img src=\"";
                    // line 405
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 405);
                    echo "\" alt=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 405);
                    echo "\"
...
\t\t\t\t\t\t\t\t\t\t\t<div class=\"post-overlay m-0\"
\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"display: none; align-items: center; position: absolute; top: 0; left: 0; width: 100%; height: 100%;\">
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row text-center justify-content-center p-4\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:30%;\"><i style=\"font-size: 30px;\"
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-heart\" aria-hidden=\"true\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 415
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 415);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"mt-3\">";
                // line 416
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 416), "html", null, true)), 0, 150);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  619 => 470,  575 => 428,  570 => 425,  555 => 416,  551 => 415,  542 => 408,  534 => 405,  531 => 404,  525 => 401,  520 => 398,  518 => 397,  510 => 391,  506 => 390,  502 => 388,  500 => 387,  429 => 318,  295 => 186,  291 => 185,  286 => 183,  276 => 176,  272 => 175,  267 => 173,  257 => 166,  253 => 165,  248 => 163,  238 => 156,  234 => 155,  229 => 153,  219 => 146,  215 => 145,  210 => 143,  200 => 136,  196 => 135,  191 => 133,  86 => 30,  77 => 27,  70 => 23,  63 => 19,  59 => 17,  55 => 16,  37 => 1,);
    }
