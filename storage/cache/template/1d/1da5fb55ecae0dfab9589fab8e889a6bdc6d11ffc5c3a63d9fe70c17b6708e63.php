...
class __TwigTemplate_164c572480080fcd906f79a366eb96cbaae4c0da4d4a702f9e8ff906e9ea92c8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t";
                // line 401
                if ((twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", true, true, false, 401) && twig_in_filter(".mp4", twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 401)))) {
                    // line 402
                    echo "\t\t\t\t\t\t\t\t\t\t\t<!-- Video section -->
...
\t\t\t\t\t\t\t\t\t\t\t<img src=\"";
                    // line 409
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 409);
                    echo "\" alt=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 409);
                    echo "\"
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 419
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 419);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"mt-3\">";
                // line 420
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 420), "html", null, true)), 0, 150);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  623 => 474,  579 => 432,  574 => 429,  559 => 420,  555 => 419,  546 => 412,  538 => 409,  535 => 408,  529 => 405,  524 => 402,  522 => 401,  514 => 395,  510 => 394,  506 => 392,  504 => 391,  429 => 318,  295 => 186,  291 => 185,  286 => 183,  276 => 176,  272 => 175,  267 => 173,  257 => 166,  253 => 165,  248 => 163,  238 => 156,  234 => 155,  229 => 153,  219 => 146,  215 => 145,  210 => 143,  200 => 136,  196 => 135,  191 => 133,  86 => 30,  77 => 27,  70 => 23,  63 => 19,  59 => 17,  55 => 16,  37 => 1,);
    }
