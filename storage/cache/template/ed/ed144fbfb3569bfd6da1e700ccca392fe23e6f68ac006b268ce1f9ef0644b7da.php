...
class __TwigTemplate_c720b195efd81c6e5a7c957d5a3d8eb3be5cc75bbe200bc43e433b944aff09c4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<p style=\"color:#eda941;\">GET 15% DISCOUNT ON YOUR FIRST PURCHASE. USE CODE:<span class=\"color:#eda941;font-weight: 600;font-size: 16px;\">FIRST15</span>
\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t</div>
