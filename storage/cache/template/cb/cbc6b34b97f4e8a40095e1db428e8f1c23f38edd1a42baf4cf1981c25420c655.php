...
class __TwigTemplate_f99a9dedc3a69fe502d07a7fa8cdd9fbc6283cbb1d9a2c1a1de141d5b5f80955 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<h1 style=\"color:#32baa1;    font-size: xxx-large;text-transform: capitalize;\">Artistry in every stitch</h1>
\t\t\t\t
\t\t\t\t
\t\t\t\t<p style=\"font-size: 20px;\">Read our blogs which connects you with our artistry</p>
\t\t\t\t
\t\t\t</div>
\t\t\t<div class=\"col-md-5\">
\t\t\t\t<img style=\"margin:auto;\" src=\"image/new/l1/41.png\" title=\"\" alt=\"\" class=\"img-responsive\" />
...
\t\t\t\t\t\t\t\t\t\t\tbtnsprice=\"";
                    // line 274
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 274);
                    echo "\"
...
\t\t\t\t\t\t\t\t\t\t\t";
                // line 285
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 285);
                echo "
\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 294
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 294);
                        echo "
\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #1677BC;display:none;\">";
                        // line 296
                        echo twig_get_attribute($this->env, $this->source,                         // line 297
$context["product"], "percent", [], "any", false, false, false, 297);
                        // line 298
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t";
                // line 350
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 350)) {
                    // line 351
                    echo "\t\t\t\t\t\t\t\t\t\t<i class=\"pe-7s-like\" btnid=\"";
...
\t\t\t\t\t\t\t\t\t\t\tbtnhref=\"";
                    // line 353
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 353);
                    echo "\" btnprice=\"";
...
\t\t\t\t\t\t\t\t\t";
                // line 368
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 368)) {
                    // line 369
                    echo "\t\t\t\t\t\t\t\t\t<p class=\"price mb-10\" style=\"color:  #3F817B; \">
\t\t\t\t\t\t\t\t\t\t";
                    // line 370
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 370)) {
                        // line 371
                        echo "\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #1677BC;display:none;\">";
                        // line 376
                        echo twig_get_attribute($this->env, $this->source,                         // line 377
$context["product"], "percent", [], "any", false, false, false, 377);
                        // line 378
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 382
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 382);
                        echo "
\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t";
                    }
...
\t})
    ...
    {
        return array (  1071 => 809,  654 => 394,  651 => 393,  638 => 387,  634 => 385,  628 => 382,  622 => 378,  620 => 377,  619 => 376,  614 => 374,  611 => 373,  605 => 371,  603 => 370,  600 => 369,  598 => 368,  592 => 365,  586 => 362,  583 => 361,  577 => 357,  571 => 354,  565 => 353,  559 => 352,  554 => 351,  552 => 350,  548 => 349,  539 => 345,  535 => 344,  531 => 343,  526 => 340,  521 => 339,  519 => 338,  493 => 314,  490 => 313,  477 => 307,  473 => 305,  467 => 302,  461 => 298,  459 => 297,  458 => 296,  453 => 294,  450 => 293,  444 => 291,  442 => 290,  439 => 289,  437 => 288,  431 => 285,  425 => 282,  422 => 281,  416 => 277,  410 => 274,  404 => 273,  398 => 272,  393 => 271,  391 => 270,  387 => 269,  378 => 265,  374 => 264,  370 => 263,  365 => 260,  360 => 259,  358 => 258,  343 => 245,  282 => 186,  277 => 184,  273 => 183,  264 => 177,  259 => 175,  255 => 174,  246 => 168,  241 => 166,  237 => 165,  228 => 159,  223 => 157,  219 => 156,  211 => 151,  206 => 149,  202 => 148,  90 => 38,  81 => 35,  76 => 34,  72 => 33,  37 => 1,);
    }
