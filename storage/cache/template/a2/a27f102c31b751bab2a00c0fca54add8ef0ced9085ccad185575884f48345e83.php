...
class __TwigTemplate_78972df785037dcb69e1aae0d6fbe42092ae2bb5df1630ae4030c4429ea3655c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<h3 style=\"color: black;margin-top: 15%;font-family: lato;\">The Design Symphony:
\t\t\t\t\t\t</h3>
...
\t\t\t\t\t\t<h3 style=\"color:black;margin-top: 15%;text-align: end;font-family: lato;\">From Thread to Textile:</h3>
...
\t\t\t\t\t<div class=\"col-md-6 pl-5\" style=\"align-items: center;\">
\t\t\t\t\t\t<h3 style=\"color:black;margin-top: 15%;text-align: start;font-family: lato;\">The Artisan's Canvas:</h3>
