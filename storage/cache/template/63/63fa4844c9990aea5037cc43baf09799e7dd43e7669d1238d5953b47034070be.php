...
class __TwigTemplate_a46935690317a80c8949bcc3dd5189a1d2154c2efe5accb66751202ae77b25c2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<div class=\"row mt-4 d-flex justify-content-start ml-0 mr-0\" style='max-width:auto; '>
...
\t\t\t\t\t\t\t\t\t\t\t<a href=\"https://www.instagram.com/banjara_home_india/\" style=\"font-size: 26px !important;    font-family: 'Radley', 'Georgia', serif;    text-transform: lowercase;\">@banjarahome_</a>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</li>
