...
class __TwigTemplate_8c47df4f72cc3e6f08ce745eb315d7303b1dd5c55e6c9619f009f65f11527fcb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<span class=\"color:#eda941;font-weight: 600;font-size: 12px;\">FIRST15</span>
\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t</div>
\t
\t\t\t\t\t\t\t\t</div>
