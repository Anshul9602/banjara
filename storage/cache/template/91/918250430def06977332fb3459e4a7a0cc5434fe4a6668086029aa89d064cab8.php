...
class __TwigTemplate_eb46702b64c0484d50c9742d6e867a2f398ce51b9ec5ee7f8c6a8724be09b44e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<div class=\"container\">
\t\t\t\t\t\t<div
\t\t\t\t\t\t\tclass=\"row align-items-end ptb-5\">
...
\t\t\t\t\t\t\t\t\t\t<a href=\"";
        ...
        echo ($context["text_wishlist"] ?? null);
        echo "\">
\t\t\t\t\t\t\t\t\t\t\t<img style=\"margin:auto;width:29px;\" src=\"image/icons/new/w.png\" title=\"\" alt=\"\" class=\"img-responsive \"/>
\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t</div>
