...
class __TwigTemplate_6e5665d4aab5b9e4d29982b603b44d3def6fefe7e1f3222211205280a409e0ee extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
                // line 371
                echo "\t\t\t\t\t\t\t\t<div class=\"col-md-4 p-4\" style=\"height:400px;\">
\t\t\t\t\t\t\t\t\t<div class=\"instagram-post\">
\t\t\t\t\t\t\t\t\t\t<img src=\"";
                // line 373
                echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 373);
                echo "\" alt=\"";
                echo twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 373);
                echo "\">
\t\t\t\t\t\t\t\t\t\t<div class=\"post-overlay row m-0\">
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:100%;\">Total Likes:
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 376
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 376);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:100%;\">Total Comments:
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 378
                echo twig_get_attribute($this->env, $this->source, $context["post"], "comments", [], "any", false, false, false, 378);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t<p>";
                // line 379
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 379), "html", null, true)), 0, 150);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  571 => 429,  527 => 387,  522 => 384,  511 => 379,  507 => 378,  502 => 376,  494 => 373,  490 => 371,  486 => 370,  481 => 367,  479 => 366,  419 => 308,  290 => 181,  286 => 180,  281 => 178,  271 => 171,  267 => 170,  262 => 168,  252 => 161,  248 => 160,  243 => 158,  233 => 151,  229 => 150,  224 => 148,  214 => 141,  210 => 140,  205 => 138,  195 => 131,  191 => 130,  186 => 128,  87 => 31,  78 => 28,  71 => 24,  64 => 20,  60 => 18,  56 => 17,  37 => 1,);
    }
