...
class __TwigTemplate_66a08f9144037eb6fa7d499e40e46b80c615cf217e3ec591f469ab76170a36a1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
        ...
        echo "\t\t\t\t\t</div>
\t\t\t\t\t<hr>
\t\t\t\t\t<h5 style=\"font-weight: 600;\">Description
\t\t\t\t\t</h5>
\t\t\t\t\t<hr />
\t\t\t\t\t";
        // line 384
...
\t\t\t\t\t\t<a onclick=\"\" href=\"";
                    ...
                    echo "\">
\t\t\t\t\t\t\t<p class=\"product_name\" style=\"color:#000; font-size:16px; text-transform:uppercase\">
\t\t\t\t\t\t\t\t";
                    // line 424
