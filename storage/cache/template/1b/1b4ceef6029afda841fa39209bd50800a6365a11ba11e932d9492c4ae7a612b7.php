...
class __TwigTemplate_7b62c72793d12cd8f9da9ecbda3caa3ea2a1b01825c8e1a99d77dcafeaf45b7a extends \Twig\Template
{
    private $source;
    private $macros = [];
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["children"]) {
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                                ...
                                if (twig_get_attribute($this->env, $this->source, $context["child"], "childrens", [], "any", false, false, false, 44)) {
                                    // line 45
                                    echo "\t\t\t\t<li class=\"col-md-12 hr1 pt-5 row\" style=\"text-align: start;\">
\t\t\t\t\t
\t\t\t\t\t<ul>
\t\t\t\t\t\t";
                                    // line 48
