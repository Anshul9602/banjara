...
class __TwigTemplate_b22a0407098a78c3f5b1b942b3cae1f93fadb442c6c707fed6a1b6139030981c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<h3 class=\"text-center\" style=\"margin: 10%;font-family: 'Avenir LT Std';\">At Banjara Home, every product tells a tale – a story spun
\t\t\t\t\tby skilled
...
\t\t\t\t\t\t<h3 style=\"color: black;margin-top: 15%;font-family: 'Carlito';font-weight: 600;\">The Design Symphony:
\t\t\t\t\t\t</h3>
...
\t\t\t\t\t\t<h3 style=\"color:black;margin-top: 15%;text-align: end;font-family: 'Carlito';font-weight: 600;\">From Thread to Textile:</h3>
...
\t\t\t\t\t<div class=\"col-md-6 pl-5\" style=\"align-items: center;\">
\t\t\t\t\t\t<h3 style=\"color:black;margin-top: 15%;text-align: start;font-family: 'Carlito';font-weight: 600;\">The Artisan's Canvas:</h3>
\t\t\t\t\t\t<p class=\"laptop\" style=\"font-size:18px;line-height:2;    text-align: start;    margin-top: 5%;\">
