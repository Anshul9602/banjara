...
class __TwigTemplate_0b6e4c85b660e01505243c8ee305be4c3ba86005dd92e7451ac70f938fe4f703 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<div class=\"image\">
\t\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t\t<img onclick=\"\" style=\"z-index: 99999999;\" src=\"image/icons/new/3.png\" alt=\"\" title=\"\"
\t\t\t\t\t\t\tclass=\"img-responsive pthumb\" />
\t\t\t\t\t</a>
\t\t\t\t</div>

\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t<h3 class=\"p-2 mt-3\" style=\"color:  #000; text-transform: capitalize;\">
\t\t\t\t\t\tTraditional Saga
\t\t\t\t\t</h3>
\t\t\t\t</a>
\t\t\t
...
\t\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"";
                // line 278
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 278);
                echo "\">
...
\t\t\t\t\t\t\t\t\t\t";
                // line 285
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 285)) {
                    // line 286
...
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #1677BC;display:none;\">";
                        // line 311
                        echo twig_get_attribute($this->env, $this->source,                         // line 312
$context["product"], "percent", [], "any", false, false, false, 312);
                        // line 313
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 317
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 317);
                        echo "
\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t";
                    }
...
\t\t\t\t\t\t\t\t\t\t\t<img onclick=\"\" style=\"z-index: 99999999;\" src=\"";
                // line 359
                echo twig_get_attribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 359);
                echo "\"
\t\t\t\t\t\t\t\t\t\t\t\talt=\"";
                // line 360
...
\t\t\t\t\t\t\t\t\t\t";
                // line 365
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 365)) {
                    // line 366
                    echo "\t\t\t\t\t\t\t\t\t\t<i class=\"pe-7s-like\" btnid=\"";
...
\t\t\t\t\t\t\t\t\t\t\tbtnhref=\"";
                    // line 368
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 368);
                    echo "\" btnprice=\"";
...
\t\t\t\t\t\t\t\t\t";
                // line 383
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 383)) {
                    // line 384
                    echo "\t\t\t\t\t\t\t\t\t<p class=\"price mb-10\" style=\"color:  #3F817B; \">
\t\t\t\t\t\t\t\t\t\t";
                    // line 385
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 385)) {
                        // line 386
                        echo "\t\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 386);
                        echo "
\t\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 388
...
$context["product"], "percent", [], "any", false, false, false, 392);
                        // line 393
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t})
    ...
    {
        return array (  1086 => 824,  669 => 409,  666 => 408,  653 => 402,  649 => 400,  643 => 397,  637 => 393,  635 => 392,  634 => 391,  629 => 389,  626 => 388,  620 => 386,  618 => 385,  615 => 384,  613 => 383,  607 => 380,  601 => 377,  598 => 376,  592 => 372,  586 => 369,  580 => 368,  574 => 367,  569 => 366,  567 => 365,  563 => 364,  554 => 360,  550 => 359,  546 => 358,  541 => 355,  536 => 354,  534 => 353,  508 => 329,  505 => 328,  492 => 322,  488 => 320,  482 => 317,  476 => 313,  474 => 312,  473 => 311,  468 => 309,  465 => 308,  459 => 306,  457 => 305,  454 => 304,  452 => 303,  446 => 300,  440 => 297,  437 => 296,  431 => 292,  425 => 289,  419 => 288,  413 => 287,  408 => 286,  406 => 285,  402 => 284,  393 => 280,  389 => 279,  385 => 278,  380 => 275,  375 => 274,  373 => 273,  358 => 260,  282 => 186,  277 => 184,  273 => 183,  264 => 177,  259 => 175,  255 => 174,  246 => 168,  241 => 166,  237 => 165,  228 => 159,  223 => 157,  219 => 156,  211 => 151,  206 => 149,  202 => 148,  90 => 38,  81 => 35,  76 => 34,  72 => 33,  37 => 1,);
    }
