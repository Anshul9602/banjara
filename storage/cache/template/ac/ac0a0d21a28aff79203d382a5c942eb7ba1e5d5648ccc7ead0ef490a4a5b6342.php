...
class __TwigTemplate_4beb41dae23a3315e55417a41e748b9d637fa22005f17a14fcc09811c102c9d5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t<div class=\"row text-center\">
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:50%;\"><i class=\"fa fa-heart\" aria-hidden=\"true\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 378
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 378);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:50%;\"><i class=\"fa fa-comment\" aria-hidden=\"true\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 380
