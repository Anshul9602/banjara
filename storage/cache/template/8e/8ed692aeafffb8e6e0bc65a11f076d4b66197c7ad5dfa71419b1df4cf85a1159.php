...
class __TwigTemplate_de7a12384add93b4b8708c53e4f798e87be437ecb067c7199838b906d2ccf37f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t";
                // line 391
                if ((twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", true, true, false, 391) && twig_in_filter(".mp4", twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 391)))) {
                    // line 392
                    echo "\t\t\t\t\t\t\t\t\t\t\t<!-- Video section -->
...
\t\t\t\t\t\t\t\t\t\t\t\t<source src=\"";
                    // line 395
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 395);
                    echo "\" type=\"video/mp4\">
\t\t\t\t\t\t\t\t\t\t\t</video>
\t\t\t\t\t\t\t\t\t\t\t";
                } else {
...
\t\t\t\t\t\t\t\t\t\t\t<img src=\"";
                    // line 399
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 399);
                    echo "\" alt=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 399);
                    echo "\"
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 409
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 409);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"mt-3\">";
                // line 410
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 410), "html", null, true)), 0, 150);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  613 => 464,  569 => 422,  564 => 419,  549 => 410,  545 => 409,  536 => 402,  528 => 399,  525 => 398,  519 => 395,  514 => 392,  512 => 391,  504 => 385,  500 => 384,  496 => 382,  494 => 381,  429 => 318,  295 => 186,  291 => 185,  286 => 183,  276 => 176,  272 => 175,  267 => 173,  257 => 166,  253 => 165,  248 => 163,  238 => 156,  234 => 155,  229 => 153,  219 => 146,  215 => 145,  210 => 143,  200 => 136,  196 => 135,  191 => 133,  86 => 30,  77 => 27,  70 => 23,  63 => 19,  59 => 17,  55 => 16,  37 => 1,);
    }
