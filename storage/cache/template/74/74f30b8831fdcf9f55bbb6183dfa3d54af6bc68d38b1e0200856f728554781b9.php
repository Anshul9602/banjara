...
class __TwigTemplate_508bcf1534a71b19f09c60fcf2132e00bccce62bc4740acea97d2ddf64e4d6a7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<img src=\"image/new/b1/sgb2.png\" alt=\"\" width=\"100%\">
\t\t</div>
\t\t<br>
\t\t<div class=\"col-md-3\">
...
\t<div class=\"row md-p-5 p-1\" style=\"    justify-content: space-around;\">
...
\t\t
\t\t
\t\t\t<div class=\"row\" style=\" align-items: center;min-width:900px;position: absolute;/* top: 52%; *//* left: 15%; */top: 70%;left: 50%;transform: translate(-50%, -50%);\">
\t\t\t\t
\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t<div class=\"image\">
\t\t\t\t\t\t<a href=\"\">
