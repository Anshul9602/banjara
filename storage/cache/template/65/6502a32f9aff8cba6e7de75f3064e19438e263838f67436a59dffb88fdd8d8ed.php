...
class __TwigTemplate_6fc7e06070da59ca89bb820a3fac3fe61cac6066aa6b392ef7446d8a4775308c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<h1  style=\"color:#de4d71;\">Shop</h1>
\t\t\t<h1 style=\"color:#de4d71;\">WHOLESALE</h1>
<br>
\t\t\t<p style=\"font-size: 20px;\">Welcome to the Banjara Home Wholesale Purchase,
...
\t\t</div>
\t\t<div class=\"col-md-5\">
\t\t\t<img style=\"margin:auto;\" src=\"image/new/l1/4.png\" title=\"\" alt=\"\"
...
\t\t\t\t\t\t\t\t\t\t";
                // line 264
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 264)) {
                    // line 265
...
\t\t\t\t\t\t\t\t\t\t\tbtnsprice=\"";
                    // line 268
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 268);
                    echo "\"
...
\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"";
                // line 276
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 276);
                echo "\">
...
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #1677BC;display:none;\">";
                        // line 290
                        echo twig_get_attribute($this->env, $this->source,                         // line 291
$context["product"], "percent", [], "any", false, false, false, 291);
                        // line 292
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t";
                // line 344
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 344)) {
                    // line 345
                    echo "\t\t\t\t\t\t\t\t\t\t<i class=\"pe-7s-like\" btnid=\"";
...
\t\t\t\t\t\t\t\t\t\t\t";
                // line 359
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 359);
                echo "
\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t";
                // line 362
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 362)) {
                    // line 363
                    echo "\t\t\t\t\t\t\t\t\t<p class=\"price mb-10\" style=\"color:  #3F817B; \">
\t\t\t\t\t\t\t\t\t\t";
                    // line 364
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 364)) {
                        // line 365
                        echo "\t\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 365);
                        echo "
\t\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 367
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 368
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 368);
                        echo "
\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #1677BC;display:none;\">";
                        // line 370
                        echo twig_get_attribute($this->env, $this->source,                         // line 371
$context["product"], "percent", [], "any", false, false, false, 371);
                        // line 372
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 376
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 376);
                        echo "
\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t";
                    }
...
\t})
    ...
    {
        return array (  1065 => 803,  648 => 388,  645 => 387,  632 => 381,  628 => 379,  622 => 376,  616 => 372,  614 => 371,  613 => 370,  608 => 368,  605 => 367,  599 => 365,  597 => 364,  594 => 363,  592 => 362,  586 => 359,  580 => 356,  577 => 355,  571 => 351,  565 => 348,  559 => 347,  553 => 346,  548 => 345,  546 => 344,  542 => 343,  533 => 339,  529 => 338,  525 => 337,  520 => 334,  515 => 333,  513 => 332,  487 => 308,  484 => 307,  471 => 301,  467 => 299,  461 => 296,  455 => 292,  453 => 291,  452 => 290,  447 => 288,  444 => 287,  438 => 285,  436 => 284,  433 => 283,  431 => 282,  425 => 279,  419 => 276,  416 => 275,  410 => 271,  404 => 268,  398 => 267,  392 => 266,  387 => 265,  385 => 264,  381 => 263,  372 => 259,  368 => 258,  364 => 257,  359 => 254,  354 => 253,  352 => 252,  337 => 239,  282 => 186,  277 => 184,  273 => 183,  264 => 177,  259 => 175,  255 => 174,  246 => 168,  241 => 166,  237 => 165,  228 => 159,  223 => 157,  219 => 156,  211 => 151,  206 => 149,  202 => 148,  90 => 38,  81 => 35,  76 => 34,  72 => 33,  37 => 1,);
    }
