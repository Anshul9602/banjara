...
class __TwigTemplate_1a0fa68beaaf2fb17ab369bb3fab7513982f66d9935437b9620bce5270f4bc00 extends \Twig\Template
{
    private $source;
    private $macros = [];
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["children"]) {
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                                ...
                                if (twig_get_attribute($this->env, $this->source, $context["child"], "childrens", [], "any", false, false, false, 76)) {
                                    // line 77
                                    echo "\t\t\t\t<li class=\"col-md-4 pt-3 hr1 pb-2\" style=\"text-align: start;padding-left:3%;\">
