...
class __TwigTemplate_7db30a217ca34aa2900b584d6f239dff0e6fcb5ac4523ed8306f522f29772bbe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        if (($context["collection"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                // line 21
                echo "\t\t\t\t<div class=\"col-md-4 col-sm-6 mb-3 mobile-padding-0\">
...
\t\t\t\t\t\t<h2 class=\"text-start pb-4 mt-4\" style=\"color: #de4d71;    text-align: center;\">View all</h2>
\t\t\t\t\t</a>
