...
class __TwigTemplate_1a8e671dc19c5b8d6f8637ec8c540c2e84d1f1bad3ae2e751c4264f2b8370272 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t
\t\t
\t\t\t<div class=\"row\" style=\" align-items: center;max-width:80%;margin:auto;position: absolute;/* top: 52%; *//* left: 15%; */top: 64%;left: 50%;transform: translate(-50%, -50%);\">
\t\t\t\t
\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t<div class=\"image\">
\t\t\t\t\t\t<a onclick=\"\" href=\"\">
