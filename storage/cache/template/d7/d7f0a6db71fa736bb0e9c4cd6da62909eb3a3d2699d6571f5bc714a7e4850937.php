...
class __TwigTemplate_15bde768605d60c70b08adc8e1bc74e2db51d956d77b7e26c58ad469e7f23add extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
                ...
                echo "                <div class=\"col-md-4 p-2\">
                    <div class=\"instagram-post\">
                        <a href=\"";
                // line 374
                echo twig_get_attribute($this->env, $this->source, $context["post"], "link", [], "any", false, false, false, 374);
                echo "\" target=\"_blank\">
                            ";
                // line 375
                if (twig_get_attribute($this->env, $this->source, $context["post"], "is_video", [], "any", false, false, false, 375)) {
                    // line 376
                    echo "                                <video controls style=\"width: 100%;\">
                                    <source src=\"";
                    // line 377
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 377);
                    echo "\" type=\"video/mp4\">
                    ...
                    // line 381
                    echo "                                <img src=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 381);
                    echo "\" alt=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 381);
                            ...
                            <div class=\"post-overlay m-0\" style=\"display: none; align-items: center;\">
                                <div class=\"row text-center justify-content-center p-4\">
                                    <p style=\"width:30%;\"><i style=\"font-size: 30px;\" class=\"fa fa-heart\" aria-hidden=\"true\"></i>
                                        ";
                // line 387
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 387);
                echo "</p>
                                    <p style=\"width:30%;\"><i style=\"font-size: 30px;\" class=\"fa fa-comment\" aria-hidden=\"true\"></i>
                                        ";
                // line 389
                echo twig_get_attribute($this->env, $this->source, $context["post"], "comments", [], "any", false, false, false, 389);
                echo "</p>
                                    <p class=\"mt-3\">";
                // line 390
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 390), "html", null, true)), 0, 150);
                echo "</p>
                                </div>
                            </div>
                        </a>
...
";
    ...
    {
        return array (  596 => 442,  552 => 400,  547 => 397,  534 => 390,  530 => 389,  525 => 387,  519 => 383,  511 => 381,  504 => 377,  501 => 376,  499 => 375,  495 => 374,  491 => 372,  487 => 371,  482 => 368,  480 => 367,  419 => 308,  290 => 181,  286 => 180,  281 => 178,  271 => 171,  267 => 170,  262 => 168,  252 => 161,  248 => 160,  243 => 158,  233 => 151,  229 => 150,  224 => 148,  214 => 141,  210 => 140,  205 => 138,  195 => 131,  191 => 130,  186 => 128,  87 => 31,  78 => 28,  71 => 24,  64 => 20,  60 => 18,  56 => 17,  37 => 1,);
    }
