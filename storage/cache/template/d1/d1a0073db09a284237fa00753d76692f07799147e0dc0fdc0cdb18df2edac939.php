...
class __TwigTemplate_40e82c8af87397e47c93b6f7d12b90a02e44a2776842ec625613422c08a4e786 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t
\t\t\t<h2 class=\"text-center col-md-10\" style=\"margin: 5% auto;color:#de4d71;\">Step into the Handmade luxe of Banjara Home,
...
\t\t\t\t\t<p class=\"laptop\" style=\"font-size:16px;line-height:2;    margin-top: 20%;\">My personal journey in the export industry has been
...
\t\t\t\t\t<p class=\"laptop\" style=\"font-size:16px;line-height:2;    text-align: end;    margin-top: 20%;\">Every product we offer is a piece of our passion and pride.
...
\t\t\t\t\t\t
\t\t\t\t\t</p>
\t\t\t\t\t<p class=\"laptop\" style=\"font-size:16px;line-height:2;    text-align: end;\">Welcome to a world where tradition meets modern
