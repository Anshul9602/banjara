...
class __TwigTemplate_c413d7fbf1a4abecfa55e82715c55db135827089f14898390956c35755ad80f5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<h3 style=\"color: black;margin-top: 15%;font-family: 'Avenir LT Std';\">The Design Symphony:
\t\t\t\t\t\t</h3>
...
\t\t\t\t\t\t<h3 style=\"color:black;margin-top: 15%;text-align: end;font-family: 'Avenir LT Std';\">From Thread to Textile:</h3>
...
\t\t\t\t\t<div class=\"col-md-6 pl-5\" style=\"align-items: center;\">
\t\t\t\t\t\t<h3 style=\"color:black;margin-top: 15%;text-align: start;font-family: 'Avenir LT Std';\">The Artisan's Canvas:</h3>
