...
class __TwigTemplate_77a5e26019abb84f7a6955d63fa7a2344b70c797522572de507e642ea99723c7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<input type=\"text\" id=\"search_bot\" placeholder=\"Search\" class=\"header-search-field\"
\t\t\t\t\t\tstyle=\"    height: 60px;\">
\t\t\t\t\t<button class=\"search_icon_top header-search-btn bot_btn\">
\t\t\t\t\t\t<img style=\"margin:auto;width:30px;\" src=\"image/icons/new/31.png\" title=\"\" alt=\"\"
