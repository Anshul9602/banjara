...
class __TwigTemplate_04a65020f306e314d1f83c36f5cf154145cf42c0971a5273ed29eeacb0841e06 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<h3 style=\"color: black;margin-top: 15%;\">Connecting the Threads of Home:
\t\t\t\t\t\t</h3>
\t\t\t\t\t\t<p class=\"laptop\" style=\"font-size:18px;line-height:2;    margin-top: 1%;\">The motto is clear:
...
\t\t\t\t\t\t<h3 style=\"color:black;margin-top: 15%;\">Embark on the Journey:</h3>
\t\t\t\t\t\t<p class=\"laptop\" style=\"font-size:18px;line-height:2;    text-align: end;    margin-top: 2%;\">
