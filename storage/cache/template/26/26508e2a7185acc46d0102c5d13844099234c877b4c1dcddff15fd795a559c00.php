...
class __TwigTemplate_bbc32ef10439eb1c5425168762bbc1cd26ec4ed246aec8bfeb0f892ab0b624ff extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
                    ...
                    if ((twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 34) == "Wholesale")) {
                        ...
                        echo "\t\t\t<div class=\"newd\">
\t\t\t\t<ul class=\"dropdown \"
\t\t\t\t\tstyle=\"   width: -webkit-fill-available;left: 0%;padding: 0px 0px;position: fixed;top: 106px;height: 80vh;overflow-y: scroll;padding-bottom:20px;\">
...
\t\t\t";
                        ...
                        echo "\t\t\t<div class=\"newd\">
\t\t\t\t<ul class=\"dropdown \"
\t\t\t\t\tstyle=\"  width: -webkit-fill-available;left: 0%;padding: 0px 0px;position: fixed;top: 106px;height: 80vh;overflow-y: scroll;\">
\t\t\t\t\t<div class=\"row\" style=\"max-width: 80%; margin:auto;\">
\t\t\t\t\t\t";
                        // line 103
                        $context['_parent'] = $context;
