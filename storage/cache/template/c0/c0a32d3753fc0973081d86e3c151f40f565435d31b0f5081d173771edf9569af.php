...
class __TwigTemplate_26616249436262eecaabd539127b5b2bf417a7b5ef29b8cb29d10aacad8ae837 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
                // line 388
                if ((twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", true, true, false, 388) && twig_in_filter(".mp4", twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 388)))) {
                    // line 389
                    echo "\t\t\t\t\t\t\t\t\t<!-- Video section -->
\t\t\t\t\t\t\t\t\t<video autoplay muted style=\"width: 100%;max-height: 400px;\" >
\t\t\t\t\t\t\t\t\t\t<source src=\"";
                    // line 391
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 391);
                    echo "\" type=\"video/mp4\">
\t\t\t\t\t\t\t\t\t</video>
\t\t\t\t\t\t\t\t\t";
                } else {
...
\t\t\t\t\t\t\t\t\t<img src=\"";
                    ...
                    echo "\" alt=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 395);
                    echo "\" style=\"width: 100%;max-height: 400px;\">
\t\t\t\t\t\t\t\t\t";
                }
                // line 397
                echo "
...
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 403
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 403);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t<p class=\"mt-3\">";
                // line 404
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 404), "html", null, true)), 0, 150);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</a>
...
";
    ...
    {
        return array (  608 => 456,  564 => 414,  559 => 411,  546 => 404,  542 => 403,  534 => 397,  527 => 395,  524 => 394,  518 => 391,  514 => 389,  512 => 388,  508 => 387,  504 => 385,  500 => 384,  496 => 382,  494 => 381,  429 => 318,  295 => 186,  291 => 185,  286 => 183,  276 => 176,  272 => 175,  267 => 173,  257 => 166,  253 => 165,  248 => 163,  238 => 156,  234 => 155,  229 => 153,  219 => 146,  215 => 145,  210 => 143,  200 => 136,  196 => 135,  191 => 133,  86 => 30,  77 => 27,  70 => 23,  63 => 19,  59 => 17,  55 => 16,  37 => 1,);
    }
