...
class __TwigTemplate_480c3189b2cabf1c1acd31c76c16d63da9e9f1e924ae5c0f83f2ddc310a1cee9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t
\t\t
\t\t\t<div class=\"row\" style=\" align-items: center;max-width:80%;position: absolute;/* top: 52%; *//* left: 15%; */top: 64%;left: 50%;transform: translate(-50%, -50%);\">
\t\t\t\t
\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t<div class=\"image\">
\t\t\t\t\t\t<a onclick=\"\" href=\"\">
