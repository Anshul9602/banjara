...
class __TwigTemplate_af5caf756845b9b7f53c8e4b699961977a2e6775d86f4f2c558fb6a38b7eebd0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<h1 style=\"text-transform:uppercase;color:#de4d71;\">Shop By Saga</h1>
\t\t\t</div>
\t
\t</div>
</section>
...
\t\t\t\t\t\t\t\t\t\t";
                // line 77
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 77)) {
                    // line 78
...
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #1677BC;display:none;\">";
                        // line 103
                        echo twig_get_attribute($this->env, $this->source,                         // line 104
$context["product"], "percent", [], "any", false, false, false, 104);
                        // line 105
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t";
                // line 157
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 157)) {
                    // line 158
                    echo "\t\t\t\t\t\t\t\t\t\t<i class=\"pe-7s-like\" btnid=\"";
...
$context["product"], "percent", [], "any", false, false, false, 184);
                        // line 185
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t<div class=\"product-card text-center\">
\t\t\t\t\t\t\t\t\t<div class=\"image\"style=\"width: 110px;background: white;    border-radius: 50%;padding: 20px;    margin: auto;\">
\t\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t\t\t\t\t\t\t<svg data-v-13a3f4da=\"\" viewBox=\"0 0 40 40\"style=\"width: 70px;background: transparent;\"
...
\t\t\t\t\t\t\t\t\t<div class=\"image\" style=\"width: 110px;background: white;    border-radius: 50%;padding: 20px;    margin: auto;\">
\t\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t\t\t\t\t\t\t<svg data-v-13a3f4da=\"\" viewBox=\"0 0 40 40\" style=\"width: 70px;background: transparent;\"class=\"inline-block h-10 w-10 fill-current icon icon--social-good\"><g><g>
<path d=\"M25.8,11.7v1.9c0,1.2,0.6,1.3,1.6,1.3h4.9v1.4C31.5,16.6,31,17.3,31,18l-8.8,2.2c-0.4-0.7-1.2-1.1-2-1.2
    ...
    c0.1,0,0.2,0,0.3,0.1v0.1h0.1c0.1,0.1,0.1,0.2,0.2,0.3c0,0,0,0.1,0,0.1c0,0.4-0.3,0.6-0.6,0.6S6.5,25,6.5,24.6z\"></path>
...
<path d=\"M37.9,4.4h-10v6.1h10V4.4z M29.2,9.2V5.7h7.4v3.5H29.2z\"></path>
...
\t\t\t\t\t\t\t\t\t<div class=\"image\"style=\"width: 110px;background: white;    border-radius: 50%;padding: 20px;    margin: auto;\">
\t\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t\t\t\t\t\t\t<svg data-v-13a3f4da=\"\" viewBox=\"0 0 40 40\" style=\"width: 70px;background: transparent;\"class=\"inline-block h-10 w-10 fill-current icon icon--eco-friendly\"><g><g>
...
\t\t\t\t\t\t\t\t\t<div class=\"image\"style=\"width: 110px;background: white;    border-radius: 50%;padding: 20px;    margin: auto;\">
\t\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t\t\t\t\t\t\t<svg data-v-13a3f4da=\"\" viewBox=\"0 0 40 40\" style=\"width: 70px;background: transparent;\"class=\"inline-block h-10 w-10 fill-current icon icon--handmade\"><g><g>
...
\t\t\t\t\t\t\t\t\t\tMake a difference with unique products that are created with great effort and love.
...
\t\t\t\t\t\t\t\t\t<div class=\"image\"style=\"width: 110px;background: white;    border-radius: 50%;padding: 20px;    margin: auto;\">
\t\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t\t\t\t\t\t\t<svg data-v-13a3f4da=\"\" viewBox=\"0 0 40 40\" style=\"width: 70px;background: transparent;\"class=\"inline-block h-10 w-10 fill-current icon icon--eco\"><g><g>
...
\t\t\t\t\t\t\t\t\t<div class=\"image\"style=\"width: 110px;background: white;    border-radius: 50%;padding: 20px;    margin: auto;\">
\t\t\t\t\t\t\t\t\t\t<a onclick=\"\" href=\"\">
\t\t\t\t\t\t\t\t\t\t\t<svg data-v-13a3f4da=\"\" viewBox=\"0 0 40 40\" style=\"width: 70px;background: transparent;\"class=\"inline-block h-10 w-10 fill-current icon icon--locally-produced\"><g><g>
...
\t})
    ...
    {
        return array (  908 => 637,  526 => 258,  521 => 256,  517 => 255,  510 => 251,  505 => 249,  501 => 248,  494 => 244,  489 => 242,  485 => 241,  477 => 236,  472 => 234,  468 => 233,  459 => 227,  454 => 225,  450 => 224,  442 => 219,  437 => 217,  433 => 216,  416 => 201,  413 => 200,  400 => 194,  396 => 192,  390 => 189,  384 => 185,  382 => 184,  381 => 183,  376 => 181,  373 => 180,  367 => 178,  365 => 177,  362 => 176,  360 => 175,  354 => 172,  348 => 169,  345 => 168,  339 => 164,  333 => 161,  327 => 160,  321 => 159,  316 => 158,  314 => 157,  310 => 156,  301 => 152,  297 => 151,  293 => 150,  288 => 147,  283 => 146,  281 => 145,  255 => 121,  252 => 120,  239 => 114,  235 => 112,  229 => 109,  223 => 105,  221 => 104,  220 => 103,  215 => 101,  212 => 100,  206 => 98,  204 => 97,  201 => 96,  199 => 95,  193 => 92,  187 => 89,  184 => 88,  178 => 84,  172 => 81,  166 => 80,  160 => 79,  155 => 78,  153 => 77,  149 => 76,  140 => 72,  136 => 71,  132 => 70,  127 => 67,  122 => 66,  120 => 65,  105 => 52,  88 => 36,  79 => 33,  74 => 32,  70 => 31,  37 => 1,);
    }
