...
class __TwigTemplate_ff001a676688ad6aebb7306cffadfb1a0ca33591027df9cdd61603f57f18d12c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<p style=\"font-size:14px\">";
            // line 142
            echo twig_get_attribute($this->env, $this->source, $context["total"], "text", [], "any", false, false, false, 142);
            echo "</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
