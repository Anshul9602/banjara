...
class __TwigTemplate_092607317b044e437d3eb0d845a324c0afbee9e40ebb1dfc5e1eba8c2cc28123 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t";
                                    // line 57
                                    if (twig_get_attribute($this->env, $this->source, $context["category"], "image", [], "any", false, false, false, 57)) {
                                        // line 58
                                        echo "            <img src=\"";
                                        echo twig_get_attribute($this->env, $this->source, $context["category"], "image", [], "any", false, false, false, 58);
                                        echo "\" alt=\"";
        ...
        ";
                                    ...
                                    // line 60
                                    echo "\t\t\t\t\t\t\t\t\t\t\t<p  style=\" color:#32baa1;font-weight: 800;    text-transform: uppercase; \" >";
