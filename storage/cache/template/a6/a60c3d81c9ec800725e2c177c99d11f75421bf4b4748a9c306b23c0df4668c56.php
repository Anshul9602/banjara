...
class __TwigTemplate_34a1390b8589d6fe3d2f08bce7e72c50c8820e178d97e5c7b2d1014e5c9e0a58 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<h1 style=\"color:#de4d71;    font-size: xxx-large;\">Artistry in every stitch</h1>
\t\t\t\t
\t\t\t\t<br>
\t\t\t\t
\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t";
                // line 269
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 269)) {
                    // line 270
...
\t\t\t\t\t\t\t\t\t";
                // line 287
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 287)) {
                    // line 288
...
\t\t\t\t\t\t\t\t\t\t";
                    ...
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 289)) {
                        // line 290
                        echo "\t\t\t\t\t\t\t\t\t\t";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 290);
                        echo "
\t\t\t\t\t\t\t\t\t\t";
                    } else {
                        // line 292
...
$context["product"], "percent", [], "any", false, false, false, 296);
                        // line 297
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t";
                // line 349
                if ( !twig_get_attribute($this->env, $this->source, $context["product"], "wish", [], "any", false, false, false, 349)) {
                    // line 350
                    echo "\t\t\t\t\t\t\t\t\t\t<i class=\"pe-7s-like\" btnid=\"";
...
\t\t\t\t\t\t\t\t\t\t\tbtnsprice=\"";
                    // line 353
                    echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 353);
                    echo "\"
\t\t\t\t\t\t\t\t\t\t\tstyle=\"color: #ee378a; font-size:24px;\"></i>
\t\t\t\t\t\t\t\t\t\t";
                } else {
...
\t\t\t\t\t\t\t\t\t";
                // line 367
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 367)) {
                    // line 368
                    echo "\t\t\t\t\t\t\t\t\t<p class=\"price mb-10\" style=\"color:  #3F817B; \">
\t\t\t\t\t\t\t\t\t\t";
                    // line 369
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 369)) {
                        // line 370
                        echo "\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 373
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 373);
                        echo "
\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t<span style=\"text-decoration:none; color: #1677BC;display:none;\">";
                        // line 375
                        echo twig_get_attribute($this->env, $this->source,                         // line 376
$context["product"], "percent", [], "any", false, false, false, 376);
                        // line 377
                        echo "%
\t\t\t\t\t\t\t\t\t\t\tOFF</span>
\t\t\t\t\t\t\t\t\t\t</span>
...
\t})
    ...
    {
        return array (  1070 => 808,  653 => 393,  650 => 392,  637 => 386,  633 => 384,  627 => 381,  621 => 377,  619 => 376,  618 => 375,  613 => 373,  610 => 372,  604 => 370,  602 => 369,  599 => 368,  597 => 367,  591 => 364,  585 => 361,  582 => 360,  576 => 356,  570 => 353,  564 => 352,  558 => 351,  553 => 350,  551 => 349,  547 => 348,  538 => 344,  534 => 343,  530 => 342,  525 => 339,  520 => 338,  518 => 337,  492 => 313,  489 => 312,  476 => 306,  472 => 304,  466 => 301,  460 => 297,  458 => 296,  457 => 295,  452 => 293,  449 => 292,  443 => 290,  441 => 289,  438 => 288,  436 => 287,  430 => 284,  424 => 281,  421 => 280,  415 => 276,  409 => 273,  403 => 272,  397 => 271,  392 => 270,  390 => 269,  386 => 268,  377 => 264,  373 => 263,  369 => 262,  364 => 259,  359 => 258,  357 => 257,  342 => 244,  282 => 186,  277 => 184,  273 => 183,  264 => 177,  259 => 175,  255 => 174,  246 => 168,  241 => 166,  237 => 165,  228 => 159,  223 => 157,  219 => 156,  211 => 151,  206 => 149,  202 => 148,  90 => 38,  81 => 35,  76 => 34,  72 => 33,  37 => 1,);
    }
