...
class __TwigTemplate_96619717aa166e1bbc3c5e773d9a9a5d3afe89269f1f08c1906fc1f87ee12344 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<a href=\"";
            // line 137
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 137);
            echo "\">
...
\t\t\t\t\t<a href=\"";
            // line 141
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 141);
            echo "\">
...
\t\t\t\t\t<img src=\"";
            // line 145
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 145);
...
<section class=\"slider-area\" style=\"background-image: url('image/new/b1/sgb.png');background-size: cover;\">
\t<div class=\"row pt-5 pb-5\" style=\"    justify-content: space-around;\">

\t\t<div class=\"col-sm-12 text-center  pb-4\">
\t\t\t<h1 style=\"min-height:80px;\">Shop By Saga</h1>
\t\t</div>
\t\t<br>
\t\t<div class=\"col-md-3\">
...
\t\t\t\t<p class=\"mt-4 buymh\" ></p>
\t\t\t\t<a href=\"index.php?route=common/wholesale\"><button class=\"btn btn-primary mt-4\"
\t\t\t\t\t\tstyle=\"margin-left: 12%;padding: 3% 9%;\">View All</button></a>
\t\t\t</div>
...
\t})
    ...
    {
        return array (  618 => 505,  544 => 433,  410 => 301,  406 => 300,  401 => 298,  391 => 291,  387 => 290,  382 => 288,  372 => 281,  368 => 280,  363 => 278,  353 => 271,  349 => 270,  344 => 268,  334 => 261,  330 => 260,  325 => 258,  315 => 251,  311 => 250,  306 => 248,  204 => 148,  195 => 145,  188 => 141,  181 => 137,  177 => 135,  173 => 134,  37 => 1,);
    }
