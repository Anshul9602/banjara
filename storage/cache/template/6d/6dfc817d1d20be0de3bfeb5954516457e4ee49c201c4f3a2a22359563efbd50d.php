...
class __TwigTemplate_6f3a22d4eda1a13171d44540ac0bf2b2193dc2411d5728a87cb4238d8d969bf3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
                // line 385
                echo "\t\t\t\t\t\t<a href=\"https://www.instagram.com/banjarahome_/\"><div class=\"col-md-4 p-2\">
\t\t\t\t\t\t\t<div class=\"instagram-post\">
\t\t\t\t\t\t\t\t<a href=\"";
                // line 387
                echo twig_get_attribute($this->env, $this->source, $context["post"], "permalink", [], "any", false, false, false, 387);
                echo "\" target=\"_blank\">
\t\t\t\t\t\t\t\t\t<div class=\"cmm\"
\t\t\t\t\t\t\t\t\t\tstyle=\"width: 400px; height: 400px; position: relative; overflow: hidden;\">
\t\t\t\t\t\t\t\t\t\t";
                // line 390
                if ((twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", true, true, false, 390) && twig_in_filter(".mp4", twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 390)))) {
                    // line 391
                    echo "\t\t\t\t\t\t\t\t\t\t<!-- Video section -->
...
\t\t\t\t\t\t\t\t\t\t\t<source src=\"";
                    // line 394
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 394);
                    echo "\" type=\"video/mp4\">
\t\t\t\t\t\t\t\t\t\t</video>
\t\t\t\t\t\t\t\t\t\t";
                } else {
...
\t\t\t\t\t\t\t\t\t\t<img src=\"";
                    // line 398
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "media_url", [], "any", false, false, false, 398);
                    echo "\" alt=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 398);
                    echo "\"
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 408
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 408);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"mt-3\">";
                // line 409
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 409), "html", null, true)), 0, 150);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  614 => 462,  570 => 420,  565 => 417,  551 => 409,  547 => 408,  538 => 401,  530 => 398,  527 => 397,  521 => 394,  516 => 391,  514 => 390,  508 => 387,  504 => 385,  500 => 384,  496 => 382,  494 => 381,  429 => 318,  295 => 186,  291 => 185,  286 => 183,  276 => 176,  272 => 175,  267 => 173,  257 => 166,  253 => 165,  248 => 163,  238 => 156,  234 => 155,  229 => 153,  219 => 146,  215 => 145,  210 => 143,  200 => 136,  196 => 135,  191 => 133,  86 => 30,  77 => 27,  70 => 23,  63 => 19,  59 => 17,  55 => 16,  37 => 1,);
    }
