...
class __TwigTemplate_e5b153661dc35c3ca73e1baf20561774f31ffa5b4e0b30142be55a89639f3e04 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<h2 class=\"text-center col-md-10\" style=\"margin: 7% auto;color:#de4d71;     font-weight: 500;   font-family: 'Radley', sans-serif;\">Step into the Handmade luxe of
\t\t\t\tBanjara Home,
\t\t\t\twhere tradition meets Modernity.</h2>
\t\t\t<div class=\"col-md-8\" style=\"margin: 5% auto;\">
\t\t\t\t<h5 style=\"text-align: center;\">\"Hello and a warm welcome to Banjara Home! I'm Sanjay Rathi, proud to
\t\t\t\t\tcarry
