...
class __TwigTemplate_f8d609604d96508b9cef2f8670f374972fdd0dce4d3e6ec79f7038f78b1215a4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["children"]) {
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                                // line 89
                                echo "\t\t\t\t";
                                if (twig_get_attribute($this->env, $this->source, $context["child"], "childrens", [], "any", false, false, false, 89)) {
                                    // line 90
                                    echo "\t\t\t\t<li class=\"col-md-4 pt-3 hr1 pb-2\" style=\"text-align: center;\">
\t\t\t\t\t";
                                    // line 91
                                    if (twig_get_attribute($this->env, $this->source, $context["child"], "image", [], "any", false, false, false, 91)) {
                                        // line 92
                                        echo "\t\t\t\t\t<img src=\"";
                                        echo twig_get_attribute($this->env, $this->source, $context["child"], "image", [], "any", false, false, false, 92);
                                        echo "\" alt=\"";
...
\t\t\t\t\t\t";
                                    // line 100
                                    $context['_parent'] = $context;
                                    $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["child"], "childrens", [], "any", false, false, false, 100));
                                    foreach ($context['_seq'] as $context["_key"] => $context["child1"]) {
                                        // line 101
                                        echo "\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t<a href=\"";
                                        // line 102
                                        echo twig_get_attribute($this->env, $this->source, $context["child1"], "href", [], "any", false, false, false, 102);
                                        echo "\" style=\"font-size: 18px; color:#32baa1;\">";
                                        echo twig_get_attribute($this->env, $this->source, $context["child1"], "name", [], "any", false, false, false, 102);
                                        echo "</a>
\t\t\t\t\t\t</li>
\t\t\t\t\t\t";
                                    }
...
\t\t\t<a href=\" ";
                    // line 122
                    echo twig_get_attribute($this->env, $this->source, $context["category"], "href", [], "any", false, false, false, 122);
                    echo " \">";
...
\t</ul>
    ...
    {
        return array (  340 => 129,  334 => 126,  328 => 125,  320 => 122,  317 => 121,  312 => 118,  308 => 116,  302 => 115,  296 => 114,  289 => 110,  285 => 109,  282 => 108,  277 => 105,  266 => 102,  263 => 101,  259 => 100,  254 => 98,  249 => 96,  245 => 94,  237 => 92,  235 => 91,  232 => 90,  229 => 89,  224 => 88,  220 => 86,  215 => 83,  211 => 81,  205 => 80,  198 => 78,  191 => 74,  187 => 73,  183 => 72,  175 => 67,  169 => 64,  163 => 61,  157 => 58,  153 => 56,  148 => 53,  137 => 50,  134 => 49,  130 => 48,  125 => 45,  122 => 44,  117 => 43,  113 => 41,  107 => 38,  99 => 33,  93 => 30,  87 => 27,  81 => 24,  75 => 20,  73 => 19,  67 => 18,  63 => 16,  61 => 15,  57 => 13,  53 => 12,  48 => 9,  46 => 8,  37 => 1,);
    }
