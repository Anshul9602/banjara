...
class __TwigTemplate_860401a21936802e6bc8a70a9a862244ddb6b0d0ca1d0b6748bbbca76a496968 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
                    ...
                    if ((twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 34) == "Wholesale")) {
                        // line 35
                        echo "\t\t\t<div class=\"newd\" style=\"width: -webkit-fill-available;\">
\t\t\t\t<ul class=\"dropdown row  \"
\t\t\t\t\tstyle=\"   width: 80%;left: 0%;padding: 0px 0px;position: fixed;top: 164px;height: 80vh;overflow-y: scroll;padding-bottom:20px;\">
...
\t\t\t";
                        ...
                        echo "\t\t\t<div class=\"newd\"style=\"width: -webkit-fill-available;\">
\t\t\t\t<ul class=\"dropdown row \"
\t\t\t\t\tstyle=\"  width: 80%;left: 0%;padding: 0px 0px;position: fixed;top: 164px;height: 80vh;overflow-y: scroll;\">
