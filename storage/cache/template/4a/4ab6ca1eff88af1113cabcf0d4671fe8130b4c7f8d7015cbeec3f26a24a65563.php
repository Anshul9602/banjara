...
class __TwigTemplate_7d80c7933beaf9e3ad4e00cade4ca45937c6598231eedacf8fa2c2b2fcfeecf7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t</h3>
\t\t\t\t<p class=\"pt-3\" style=\"color:#fff;font-size:18px;\">By s igning up for aler t s , you agree to receive e-mai l s ,
cal l s and text mes sages f rom Banjara Home.</p>
\t\t\t</div>
...
\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t\t\t<div class=\"col-md-4 col-5 \" style=\"text-align: start;color:#fff;\">
\t\t\t\t\t\t\t\t\t\t<p>TOLL FREE :</p>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"col-md-8 col-7\" style=\"text-align: start;color:#fff;\">
\t\t\t\t\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t\t\t\t\t+91 90017 09690
</p>
\t\t\t\t\t\t\t\t\t</div>
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["style"]) {
            // line 207
            echo "\t<link href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "href", [], "any", false, false, false, 207);
            echo "\" type=\"text/css\" rel=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "rel", [], "any", false, false, false, 207);
            echo "\" media=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "media", [], "any", false, false, false, 207);
            echo "\"/>
";
        }
...
";
    ...
    {
        return array (  274 => 212,  265 => 210,  261 => 209,  248 => 207,  244 => 206,  37 => 1,);
    }
