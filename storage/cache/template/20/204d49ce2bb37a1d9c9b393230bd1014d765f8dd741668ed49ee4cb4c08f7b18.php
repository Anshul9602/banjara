...
class __TwigTemplate_234cd73310b82e5c9a640adf4f6bfebc2f13d3e67f21546fced6057bfce6d6b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\tvar elementToHide = document.querySelectorAll(\".newd\");
...
\t\t// Add a hover event listener to the navigation list item
\t\tvar navListItem = document.querySelector(\"nav li\");

\t\tnavListItem.addEventListener(\"mouseenter\", function () {
\t\t\t// Display the hidden element when the user hovers over the navigation list item
