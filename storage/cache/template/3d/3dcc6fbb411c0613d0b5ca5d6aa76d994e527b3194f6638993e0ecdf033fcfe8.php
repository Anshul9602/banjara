...
class __TwigTemplate_81b5385abde7be1b9a15194751b61cc86dd80fd304bbf05b9d074eed0823bb05 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t<div class=\"row text-center\">
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:50%;\"><i style=\"    font-size: 30px;\" class=\"fa fa-heart\" aria-hidden=\"true\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 378
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 378);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:50%;\"><i style=\"    font-size: 30px;\" class=\"fa fa-comment\" aria-hidden=\"true\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 380
