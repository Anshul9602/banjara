...
class __TwigTemplate_f05293ebc28c585bf318098a513438837c65a008825216c2698cdab0018325c6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:100%;\"><i class=\"fa fa-heart\" aria-hidden=\"true\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 377
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 377);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t<p style=\"width:100%;\">Total Comments:
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 379
                echo twig_get_attribute($this->env, $this->source, $context["post"], "comments", [], "any", false, false, false, 379);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t\t<p>";
                // line 380
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 380), "html", null, true)), 0, 150);
                echo "</p>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  572 => 430,  528 => 388,  523 => 385,  512 => 380,  508 => 379,  503 => 377,  495 => 374,  491 => 372,  487 => 371,  482 => 368,  480 => 367,  419 => 308,  290 => 181,  286 => 180,  281 => 178,  271 => 171,  267 => 170,  262 => 168,  252 => 161,  248 => 160,  243 => 158,  233 => 151,  229 => 150,  224 => 148,  214 => 141,  210 => 140,  205 => 138,  195 => 131,  191 => 130,  186 => 128,  87 => 31,  78 => 28,  71 => 24,  64 => 20,  60 => 18,  56 => 17,  37 => 1,);
    }
