...
class __TwigTemplate_7c3fb4cc72bb1e52c5069cfba9d143853130c79b8d25a5a21cf5481bdf386f53 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t
\t\t
\t\t\t<div class=\"row\" style=\" align-items: center;min-width:900px;position: absolute;/* top: 52%; *//* left: 15%; */top: 64%;left: 50%;transform: translate(-50%, -50%);\">
\t\t\t\t
\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t<div class=\"image\">
\t\t\t\t\t\t<a onclick=\"\" href=\"\">
