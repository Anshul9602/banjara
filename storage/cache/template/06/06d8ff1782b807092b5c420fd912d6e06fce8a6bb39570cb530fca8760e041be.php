...
class __TwigTemplate_fc32c1010a7ae91706872b8f3e124793259cd7ba49c74a4092554be910af379a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\tdata-loading-text=\"";
        ...
        echo "\" class=\"btn btn-primary\" style=\"    padding: 10px 30px;\" />
\t\t\t\t</span>
\t\t\t</div>
\t\t</div>
\t</div>
