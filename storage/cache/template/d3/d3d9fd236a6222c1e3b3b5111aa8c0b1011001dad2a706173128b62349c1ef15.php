...
class __TwigTemplate_5ef679f6b62c5ec743cfbadae0cd46fa93711f8e2843fb4e496a33ef3facc510 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<li class=\"col-md-12 pt-3 hr1 row\" style=\"text-align: start;\">
\t\t\t\t\t<div class=\"col-md-3\">
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["children"]) {
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                                ...
                                if (twig_get_attribute($this->env, $this->source, $context["child"], "childrens", [], "any", false, false, false, 44)) {
                                    // line 45
                                    echo "\t\t\t\t<li class=\"col-md-12 hr1 pb-2 row\" style=\"text-align: start;\">
\t\t\t\t\t
\t\t\t\t\t<ul>
\t\t\t\t\t\t";
                                    // line 48
