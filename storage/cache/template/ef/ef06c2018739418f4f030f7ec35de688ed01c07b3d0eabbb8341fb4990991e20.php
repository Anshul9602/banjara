...
class __TwigTemplate_a9c715792841efd51d686502a253995c688ca0f561073e1b4b374b281a707f9f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t</h3>
\t\t\t\t<p class=\"pt-3\" style=\"color:#fff;font-size:18px;\">By signing up for alerts, you agree to receive e-mails, calls and text messages from Banjara Home.</p>
\t\t\t</div>
...
\t\t\t\t\t\t\t<br>
\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t<p style=\"font-size: 16px;color:#fff;\">TO SEE MORE OF OUR WORK , VISIT OUR SOCIALS :</p>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li>
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["style"]) {
            // line 195
            echo "\t<link href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "href", [], "any", false, false, false, 195);
            echo "\" type=\"text/css\" rel=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "rel", [], "any", false, false, false, 195);
            echo "\" media=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "media", [], "any", false, false, false, 195);
            echo "\"/>
";
        }
...
";
    ...
    {
        return array (  262 => 200,  253 => 198,  249 => 197,  236 => 195,  232 => 194,  37 => 1,);
    }
