...
class __TwigTemplate_88bd9ccef121811725dff87f665976410a942831720dad745199a24a3e8e9b52 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<div class=\"row mt-4 d-flex justify-content-start ml-0 mr-0 iim\" style='max-width:auto; '>
\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-1 text-center p-0\" style=\"width:auto;\">
\t\t\t\t\t\t\t\t\t\t\t<a href=\"\"><img src=\"image/icons/new/12.png\" width=\"60\"/></a></div>
\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-1 text-center p-0\" style=\"width:auto;\">
...
\t\t\t\t\t\t\t\t\t\t\t<a  href=\"https://www.instagram.com/banjara_home_india/\" style=\"font-size: 26px ;    font-family: 'Radley', 'Georgia', serif;    text-transform: lowercase;\"><span class=\"mmmf\">@banjarahome_</span></a>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</li>
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["style"]) {
            // line 211
            echo "\t<link href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "href", [], "any", false, false, false, 211);
            echo "\" type=\"text/css\" rel=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "rel", [], "any", false, false, false, 211);
            echo "\" media=\"";
            echo twig_get_attribute($this->env, $this->source, $context["style"], "media", [], "any", false, false, false, 211);
            echo "\"/>
";
        }
...
";
    ...
    {
        return array (  278 => 216,  269 => 214,  265 => 213,  252 => 211,  248 => 210,  37 => 1,);
    }
