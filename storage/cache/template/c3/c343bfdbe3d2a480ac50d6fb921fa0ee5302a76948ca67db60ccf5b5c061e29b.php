...
class __TwigTemplate_ea793a72dc80068bdcdd39253681b495dd05c8c4e00088e1b758fbdc447d05d4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"post-overlay m-0\" style=\"display: none; align-items: center;\">
        <div class=\"row text-center justify-content-center p-4\">
            <p style=\"width:30%;\"><i style=\"font-size: 30px;\" class=\"fa fa-heart\" aria-hidden=\"true\"></i>
                ";
                // line 402
                echo twig_get_attribute($this->env, $this->source, $context["post"], "likes", [], "any", false, false, false, 402);
                echo "</p>
            <p class=\"mt-3\">";
                // line 403
                echo twig_slice($this->env, nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "caption", [], "any", false, false, false, 403), "html", null, true)), 0, 150);
                echo "</p>
        </div>
    </div>
</a>
